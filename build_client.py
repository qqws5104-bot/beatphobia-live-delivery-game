...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* each cell is styled to read as a cardboard delivery box: folded top flaps (the two diagonal
     ...
     top/bottom edge for depth, and a small barcode tucked in the bottom-right corner. */
  .cell { position:relative; aspect-ratio:1/0.78; border-radius:6px; border:none; display:flex; align-items:center; justify-content:center;
